...
<head>
  ...
  <script type="text/javascript"
          src="<?php echo Yii::app()->request->baseUrl; ?>/fancybox/jquery.fancybox-1.3.1.pack.js"></script>
  <link rel="stylesheet" type="text/css"
        href="<?php echo Yii::app()->request->baseUrl; ?>/fancybox/jquery.fancybox-1.3.1.css" />

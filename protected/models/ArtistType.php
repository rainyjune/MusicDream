 ...
 */
class ArtistType extends CActiveRecord
{
	/**
	 * The followings are the available columns in table 'artist_type':
	 * @var integer $id
	 * @var string $name
	 * @var string $intro
	 */
	 ...
	 * @return ArtistType the static model class
	 */
	...
	public function relations()
	{
		...
		return array(
			'artists' => array(self::HAS_MANY, 'Artist', 'type_id'),
		);
	}
